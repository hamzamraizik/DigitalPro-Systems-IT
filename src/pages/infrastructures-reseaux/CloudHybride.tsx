...
export default function CloudHybride() {
  return (
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-2xl">
              ...
              <p className="text-primary-foreground/70 text-lg leading-relaxed">
                Migration cloud. Découvrez comment DigitalPro Systems IT peut accompagner votre entreprise vers le succès.
              </p>
            </motion.div>
          </div>
        </ParallaxSection>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Nous mettons à votre disposition notre savoir-faire en matière de cloud hybride pour optimiser vos processus, sécuriser vos données et accroître votre performance globale. 
                </p>
